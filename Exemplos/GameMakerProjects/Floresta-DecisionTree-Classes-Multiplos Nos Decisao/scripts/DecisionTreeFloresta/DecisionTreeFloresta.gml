...
function NoDecisaoFloresta(_tipo_decisao) : NoDecisao() constructor{
	...
	pergunta = "";
	tipo_decisao = _tipo_decisao;
	
	testar_valor = function(){		
		
		if (obj_gerencia_nos.resposta != ""){
			switch(tipo_decisao){
				case TIPO_DECISAO.TEMPO:
					return ( (obj_tempo.status_tempo == "Dia") || (obj_gerencia_nos.resposta == "Sim") );
				case TIPO_DECISAO.REPOSTA_LANTERNA:
					return (obj_gerencia_nos.resposta == "Sim");
			}
		}		
