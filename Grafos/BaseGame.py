...
class BaseProblem():    
    def __init__(self, w = 960, h = 540, tile_w = 32, tile_h = 32, show_screen = True, render_game = True, scale = 1):        
        ...
        self.screen = None
        if show_screen:
            self.screen   = pygame.display.set_mode((round(self.width*self.scale), round(self.height*self.scale))) #,HWSURFACE|DOUBLEBUF|RESIZABLE)
        ...
        self.fntDefault = pygame.font.SysFont('FFF Intelligent', 12)        
        self.blocked = False
        self.dic_tiles = {}
