...
path = os.path.abspath(os.path.join("sprites", os.pardir))
RESOURCES_PATH = os.path.join(path, "sprites/")
...
class Block(Sprite):
    ID = -9
    def __init__(self, x, y, tile_width = TILE_SIZE, tile_height = TILE_SIZE, id = -9):
        self.id = id
        self.name = "Block"
        dir_tile = f"tile{tile_width}"
